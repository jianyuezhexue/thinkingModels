...
type SearchCategory struct {
	...
	Id        uint64   `json:"id" uri:"id" search:"type:eq;column:id;table:thinking_model_categories"`       // ID
	Ids       []uint64 `json:"ids" uri:"ids" search:"type:in;column:id;table:thinking_model_categories"`     // IDs
	CreatedAt []string `json:"createdAt" uri:"createdAt" search:"type:between;column:created_at;table:thinking_model_categories"` // 创建时间
	UpdatedAt []string `json:"updatedAt" uri:"updatedAt" search:"type:between;column:updated_at;table:thinking_model_categories"` // 更新时间
	Name      string   `json:"name" uri:"name" search:"type:like;column:name;table:thinking_model_categories"` // 分类名称（模糊查询）
	Heat      int      `json:"heat" uri:"heat" search:"type:eq;column:heat;table:thinking_model_categories"`  // 热度值
}
